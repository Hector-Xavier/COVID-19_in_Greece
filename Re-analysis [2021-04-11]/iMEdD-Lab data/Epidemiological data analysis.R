...
daily_timeline_data <- daily_timeline_data[,1:(dim(daily_timeline_data)[2]-1)]
...
{
  weekday_temp_data <- cbind(daily_timeline_data[index_of_comparison,as.integer(weekdays(daily_timeline_data_dates))==1][1:58],daily_timeline_data[index_of_comparison,as.integer(weekdays(daily_timeline_data_dates))==2][1:58],daily_timeline_data[index_of_comparison,as.integer(weekdays(daily_timeline_data_dates))==3][1:58],daily_timeline_data[index_of_comparison,as.integer(weekdays(daily_timeline_data_dates))==4][1:58],daily_timeline_data[index_of_comparison,as.integer(weekdays(daily_timeline_data_dates))==5][1:58],daily_timeline_data[index_of_comparison,as.integer(weekdays(daily_timeline_data_dates))==6][1:58],daily_timeline_data[index_of_comparison,as.integer(weekdays(daily_timeline_data_dates))==7][1:58])
...
weekday_temp_data <- cbind(daily_timeline_data[1,as.integer(weekdays(daily_timeline_data_dates))==1][1:58],daily_timeline_data[1,as.integer(weekdays(daily_timeline_data_dates))==2][1:58],daily_timeline_data[1,as.integer(weekdays(daily_timeline_data_dates))==3][1:58],daily_timeline_data[1,as.integer(weekdays(daily_timeline_data_dates))==4][1:58],daily_timeline_data[1,as.integer(weekdays(daily_timeline_data_dates))==5][1:58],daily_timeline_data[1,as.integer(weekdays(daily_timeline_data_dates))==6][1:58],daily_timeline_data[1,as.integer(weekdays(daily_timeline_data_dates))==7][1:58])
...
cor.test(weekday_temp_data[,2],weekday_temp_data[,7])
...
daily_timeline_data_correction[1,as.integer(weekdays(daily_timeline_data_dates))==2] <- median(weekday_temp_data[,7])/median(weekday_temp_data[,2])*daily_timeline_data_correction[1,as.integer(weekdays(daily_timeline_data_dates))==2]
...
timeline_for_segmentation <- log2(daily_timeline_data[7,])
timeline_for_segmentation_smoothed <- filter(log2(daily_timeline_data[7,]),rep(1,5)/5)
...
for (i in 1:dim(cumulative_cases_regional)[1])
{
  tryCatch({
    ...
    weekday_temp_data <- cbind(timeline_for_segmentation[as.integer(weekdays(cumulative_cases_dates))==1][1:58],timeline_for_segmentation[as.integer(weekdays(cumulative_cases_dates))==2][1:58],timeline_for_segmentation[as.integer(weekdays(cumulative_cases_dates))==3][1:58],timeline_for_segmentation[as.integer(weekdays(cumulative_cases_dates))==4][1:58],timeline_for_segmentation[as.integer(weekdays(cumulative_cases_dates))==5][1:58],timeline_for_segmentation[as.integer(weekdays(cumulative_cases_dates))==6][1:58],timeline_for_segmentation[as.integer(weekdays(cumulative_cases_dates))==7][1:58])
